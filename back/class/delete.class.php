...
class Delete
{
	...
	public function string($request)
	{
		...
		response(['message'=>'删除键'.$request['key'], 'code'=>666]);
	}
	...
	public function hash($request)
	{
		...
		response(['message'=>'删除字段'.$request['field'], 'code'=>666]);
	}
	...
	public function list($request)
	{
		...
		response(['message'=>'删除索引'.$request['index'], 'code'=>666]);
	}
	...
	public function set($request)
	{
		...
		response(['message'=>'删除值'.$request['value'], 'code'=>666]);
	}
	...
	public function zset($request)
	{
		...
		response(['message'=>'删除成员'.$request['member'], 'code'=>666]);
	}
}
